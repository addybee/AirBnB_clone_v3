...
class FileStorage:
    ...
    def get(self, cls, id):
        """
        Retrieve an object from File storage based on its class type and ID.
    ...
    def count(self, cls=None):
        """
        Retrieve the number of objects in the file storage of a specific class
        or for all classes.
